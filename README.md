...
This project implements a solution to the [Tennis](https://github.com/Unity-Technologies/ml-agents/blob/master/docs/Learning-Environment-Examples.md#tennis) environment.
...
### How to run
You can train your own agents from scratch by running the following script:
```
python train.py
```
Additionally, trained weights are already included on this repository. You can run the optimized agents by executing the next command:
```
python test.py
```